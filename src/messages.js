...
export const RECOMMENDATIONS_GREETING_RECOMMENDATIONS = 'These are the details for the'
export const RECOMMENDATIONS_GREETING_DATA = 'stock, based on data from'
export const RECOMMENDATIONS_GREETING_TO = 'to'
